...
EN_TO_RU: dict[str, str] = {
    ...
    "Files OK: %1": "Файлы в порядке: %1",
    "No installed portable games to verify": "Нет установленных portable-игр для проверки",
    "Verified %1 portable game(s) — all OK": "Проверено portable-игр: %1 — всё в порядке",
    "Verified: %1, issues: %2": "Проверено: %1, проблем: %2",
