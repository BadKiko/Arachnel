...
EN_TO_RU: dict[str, str] = {
    ...
    "Change later in Settings → Plugins.": "Позже можно сменить в Настройки → Плагины.",
    "Steam install method": "Способ установки Steam",
    "Ask each time, or always use Arachnel CDN / Steam client.": "Спрашивать каждый раз или всегда Arachnel CDN / клиент Steam.",
    "Ask each time": "Спрашивать каждый раз",
    "Arachnel (CDN)": "Arachnel (CDN)",
    "Steam client": "Клиент Steam",
    "Steam CDN · Online Fix": "Steam CDN · Online Fix",
    "How to install": "Как установить",
    "Choose how to get \"%1\".": "Выберите, как получить «%1».",
    "Choose how to download this game.": "Выберите способ загрузки этой игры.",
    "Download in Arachnel": "Скачать в Arachnel",
    "Recommended. Files come from Steam CDN; progress stays in Downloads. Online Fix can be included.": "Рекомендуется. Файлы с Steam CDN; прогресс в «Загрузках». Можно включить Online Fix.",
    "Install via Steam client": "Установить через клиент Steam",
    "If you prefer Steam’s downloader: Arachnel prepares the game, then Steam fetches the files. Launch from Steam or Arachnel.": "Если удобнее загрузчик Steam: Arachnel подготовит игру, файлы скачает Steam. Запуск — из Steam или Arachnel.",
    "Continue": "Продолжить",
    "Got it": "Понятно",
    "Done": "Готово",
    "Steam CDN + Online Fix": "Steam CDN + Online Fix",
    "Steam CDN download ready. Prefer Steam’s client? Choose that on Install.": "Готово к загрузке с Steam CDN. Хотите клиент Steam? Выберите это при установке.",
    "Show the install choice before every Steam game.": "Показывать выбор способа перед каждой игрой Steam.",
    "Always download via Arachnel from Steam CDN. Works without a Steam Store license.": "Всегда качать через Arachnel с Steam CDN. Работает без лицензии в Steam Store.",
    "Always hand off to Steam. LumaCore unlocks download even if the game is not on your account.": "Всегда отдавать установку Steam. LumaCore позволяет качать даже без игры на аккаунте.",
    "Uses LumaCore in the Steam folder so the game can download even if it is not on your account. Steam may restart once so the inject loads.": "Через LumaCore в папке Steam игра качается даже если её нет на аккаунте. Steam может один раз перезапуститься, чтобы подхватить inject.",
    "Restarting Steam for LumaCore…": "Перезапуск Steam для LumaCore…",
    "LumaCore is missing from the Steam folder. Reinstall the Steam plugin or use Download in Arachnel (CDN).": "В папке Steam нет LumaCore. Переустановите Steam-плагин или выберите «Скачать в Arachnel (CDN)».",
    "Steam still reports no license after LumaCore restart. Check that LumaCore DLLs are in the Steam folder, then retry — or use Download in Arachnel (CDN).": "Steam всё ещё пишет «нет лицензий» после перезапуска LumaCore. Проверьте DLL в папке Steam и повторите — или выберите «Скачать в Arachnel (CDN)».",
    "Preparing Steam client…": "Подготовка клиента Steam…",
    ...
    "Prepared — Steam is downloading": "Готово — Steam загружает игру",
    "Queued in Steam — restart Steam, then open the game there": "В очереди Steam — перезапустите Steam и откройте игру там",
    "Queued in Steam…": "В очереди Steam…",
    "Downloading in Steam…": "Загрузка в Steam…",
    "Waiting in Steam — click Update if needed": "Ожидание Steam — нажмите «Обновить», если нужно",
    ...
    "Could not delete plugin files": "Не удалось удалить файлы плагина",
