...
EN_TO_RU: dict[str, str] = {
    ...
    "Steam is not running — Online Fix needs it for SpaceWar/overlay. Starting Steam…": "Steam не запущен — Online Fix нужен для SpaceWar/overlay. Запускаем Steam…",
    ...
    "Shows once at startup when a newer build is available in the catalog.": "Показывает один раз при запуске, если в каталоге есть более новая сборка.",
    "DRM": "DRM",
    ...
    "Downloads updates once at startup. You can turn this off per game.": "Скачивает обновления один раз при запуске. Можно отключить для отдельной игры.",
