...
MD.BottomSheet {
    ...
    ColumnLayout {
        ...
        MD.ElevationRectangle {
            ...
            Layout.leftMargin: MD.Token.spacing.large
            Layout.rightMargin: MD.Token.spacing.large
            visible: root.onLinux && root.installed && root.gameId.length > 0
            ...
            ColumnLayout {
                ...
                readonly property var containerInfo: {
                    const _rev = root.detailsRevision
                    return root.gameId.length ? Core.gameRuntimeContainerInfo(root.gameId) : ({})
                }
                ...
                RowLayout {
                    ...
                    MD.IconButton {
                        ...
                        onClicked: Core.openGameRuntimeContainer(root.gameId)
                    }
                }
