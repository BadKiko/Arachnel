...
set(FREETP_CATALOG "${FREETP_PLUGIN_DIR}/games.json")
...
if(NOT "$ENV{ARACHNEL_SKIP_FREETP_CATALOG_FETCH}" STREQUAL "1")
    message(STATUS "freetp: fetching games.json ...")
    file(DOWNLOAD "${FREETP_CATALOG_URL}" "${FREETP_CATALOG}" STATUS _dl_status TIMEOUT 180)
    list(GET _dl_status 0 _dl_code)
    if(NOT _dl_code EQUAL 0)
        message(WARNING "freetp: could not download games.json (using sample)")
